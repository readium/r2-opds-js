...
Wiki documentation is not used, instead there are Markdown files inside the repository ([docs](https://github.com/readium/r2-opds-js/tree/develop/docs) folder).
...
https://rawgit.com/edrlab/r2-opds-js-dist/develop/dist/gitrev.json
